...
This file contains the code for CLIP fine-tuning using a classification head
"""
import numpy as np
import torch
...
class CLIPClassifier(nn.Module):
    def __init__(self, num_classes, pretrained_model="openai/clip-vit-large-patch14"):
        super().__init__()
        ...
        # Note: CLIP ViT-Large/14 has 1024-dim output instead of 512
...
if __name__ == "__main__":
    ...
    # Initialize model
    model = CLIPClassifier(num_classes=total_classes)
